...
namespace Assets.Scripts.Controllers
{
    ...
    public class PlayerControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
            GUILayout.Label("Physics Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
            EditorGUILayout.Space();

            fpc.throwForce = EditorGUILayout.Slider(new GUIContent("Throw force", "Determines how much force is applied when throwing objects."), fpc.throwForce, 1, 1000);
            GUI.enabled = true;
